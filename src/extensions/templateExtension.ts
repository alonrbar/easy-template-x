...
export abstract class TemplateExtension implements ITemplateExtension {
    ...
    public abstract getXmlDocuments(templateContext: TemplateContext): Promise<Map<string, XmlNode>>;
    ...
    public async execute(utilities: IExtensionUtilities, data: ScopeData, context: TemplateContext) {
