...
export interface ITemplateExtension {
    getXmlDocuments(templateContext: TemplateContext): Promise<Map<string, XmlNode>>;
    execute(utilities: IExtensionUtilities, data: ScopeData, context: TemplateContext): void | Promise<void>;
}